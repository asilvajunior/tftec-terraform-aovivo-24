...
# This module presents an easy way to provision your Azure Network Security Group.
...
resource "azurerm_network_security_group" "nsg" {
  name                = var.nsg_name
  location            = var.location == null ? data.azurerm_resource_group.nsg.location : var.location
